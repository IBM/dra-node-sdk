...
describe('DrAutomationServiceV1', () => {
  ...
  test('serviceInstanceUpdateApiKey request example', async () => {
    ...
    // begin-serviceInstance.updateApiKey
    ...
    // end-serviceInstance.updateApiKey
  });
  ...
  test('serviceInstanceManageDr request example', async () => {
    ...
    const contextModel = {
      ...
      dr_orchestrator_name: 'drautomationprimarynew',
      ...
      standby_orchestrator_name: 'drautomationstandbynew',
