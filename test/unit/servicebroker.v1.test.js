...
const servicebrokerService = new ServicebrokerV1(servicebrokerServiceOptions);

let createRequestMock = null;
function mock_createRequest() {
  if (!createRequestMock) {
    createRequestMock = jest.spyOn(servicebrokerService, 'createRequest');
...
describe('ServicebrokerV1', () => {
  ...
  describe('the newInstance method', () => {
    test('should use defaults when options not provided', () => {
      const testInstance = ServicebrokerV1.newInstance();

      expect(getAuthenticatorMock).toHaveBeenCalled();
      expect(testInstance.baseOptions.authenticator).toBeInstanceOf(NoAuthAuthenticator);
      expect(testInstance.baseOptions.serviceName).toBe(ServicebrokerV1.DEFAULT_SERVICE_NAME);
      expect(testInstance.baseOptions.serviceUrl).toBe(ServicebrokerV1.DEFAULT_SERVICE_URL);
      expect(testInstance).toBeInstanceOf(ServicebrokerV1);
    });
    ...
    test('should set serviceName, serviceUrl, and authenticator when provided', () => {
      ...
      const testInstance = ServicebrokerV1.newInstance(options);
  ...
  describe('the constructor', () => {
    test('use user-given service url', () => {
      ...
      const testInstance = new ServicebrokerV1(options);
  ...
  describe('serviceInstanceGetKeyV1', () => {
    describe('positive tests', () => {
      function __serviceInstanceGetKeyV1Test() {
        ...
        const serviceInstanceGetKeyV1Result = servicebrokerService.serviceInstanceGetKeyV1(
      ...
      test('should pass the right params to createRequest with enable and disable retries', () => {
        ...
        createRequestMock.mockClear();
        servicebrokerService.disableRetries();
        __serviceInstanceGetKeyV1Test();
      });
      ...
      test('should prioritize user-given headers', () => {
        ...
        servicebrokerService.serviceInstanceGetKeyV1(serviceInstanceGetKeyV1Params);
    ...
    describe('negative tests', () => {
      test('should enforce required parameters', async () => {
        let err;
        try {
          await servicebrokerService.serviceInstanceGetKeyV1({});
        } catch (e) {
          err = e;
        }
  ...
  describe('serviceInstanceValidateKey', () => {
    describe('positive tests', () => {
      function __serviceInstanceValidateKeyTest() {
        ...
        const serviceInstanceValidateKeyResult = servicebrokerService.serviceInstanceValidateKey(
          serviceInstanceValidateKeyParams
        );
      ...
      test('should prioritize user-given headers', () => {
        ...
        servicebrokerService.serviceInstanceValidateKey(serviceInstanceValidateKeyParams);
        checkMediaHeaders(createRequestMock, userAccept, userContentType);
      });
    });
    ...
    describe('negative tests', () => {
      test('should enforce required parameters', async () => {
        let err;
        try {
          await servicebrokerService.serviceInstanceValidateKey({});
        } catch (e) {
          err = e;
        }
  ...
  describe('serviceInstanceUpdateApiKey', () => {
    describe('positive tests', () => {
      function __serviceInstanceUpdateApiKeyTest() {
        ...
        const serviceInstanceUpdateApiKeyResult = servicebrokerService.serviceInstanceUpdateApiKey(
          serviceInstanceUpdateApiKeyParams
        );
      ...
      test('should prioritize user-given headers', () => {
        ...
        servicebrokerService.serviceInstanceUpdateApiKey(serviceInstanceUpdateApiKeyParams);
        checkMediaHeaders(createRequestMock, userAccept, userContentType);
      });
    });
    ...
    describe('negative tests', () => {
      test('should enforce required parameters', async () => {
        let err;
        try {
          await servicebrokerService.serviceInstanceUpdateApiKey({});
        } catch (e) {
          err = e;
        }
  ...
  describe('drGrsLocationPairsDetails', () => {
    describe('positive tests', () => {
      function __drGrsLocationPairsDetailsTest() {
        ...
        const drGrsLocationPairsDetailsResult = servicebrokerService.drGrsLocationPairsDetails(
          drGrsLocationPairsDetailsParams
        );
      ...
      test('should prioritize user-given headers', () => {
        ...
        servicebrokerService.drGrsLocationPairsDetails(drGrsLocationPairsDetailsParams);
        checkMediaHeaders(createRequestMock, userAccept, userContentType);
      });
    });
    ...
    describe('negative tests', () => {
      test('should enforce required parameters', async () => {
        let err;
        try {
          await servicebrokerService.drGrsLocationPairsDetails({});
        } catch (e) {
          err = e;
        }
  ...
  describe('serviceInstanceGetdrlocations', () => {
    describe('positive tests', () => {
      function __serviceInstanceGetdrlocationsTest() {
        ...
        const serviceInstanceGetdrlocationsResult =
          servicebrokerService.serviceInstanceGetdrlocations(serviceInstanceGetdrlocationsParams);
    ...
    describe('negative tests', () => {
      test('should enforce required parameters', async () => {
        let err;
        try {
          await servicebrokerService.serviceInstanceGetdrlocations({});
        } catch (e) {
          err = e;
        }
  ...
  describe('drManagedVmsDetails', () => {
    describe('positive tests', () => {
      function __drManagedVmsDetailsTest() {
        ...
        const drManagedVmsDetailsResult =
          servicebrokerService.drManagedVmsDetails(drManagedVmsDetailsParams);
    ...
    describe('negative tests', () => {
      test('should enforce required parameters', async () => {
        let err;
        try {
          await servicebrokerService.drManagedVmsDetails({});
        } catch (e) {
          err = e;
        }
  ...
  describe('drSummaryDetails', () => {
    describe('positive tests', () => {
      function __drSummaryDetailsTest() {
        ...
        const drSummaryDetailsResult =
          servicebrokerService.drSummaryDetails(drSummaryDetailsParams);
    ...
    describe('negative tests', () => {
      test('should enforce required parameters', async () => {
        let err;
        try {
          await servicebrokerService.drSummaryDetails({});
        } catch (e) {
          err = e;
        }
  ...
  describe('validateClusterType', () => {
    describe('positive tests', () => {
      function __validateClusterTypeTest() {
        ...
        const validateClusterTypeResult =
          servicebrokerService.validateClusterType(validateClusterTypeParams);
    ...
    describe('negative tests', () => {
      test('should enforce required parameters', async () => {
        let err;
        try {
          await servicebrokerService.validateClusterType({});
        } catch (e) {
          err = e;
        }
  ...
  describe('machinetypesDetails', () => {
    describe('positive tests', () => {
      function __machinetypesDetailsTest() {
        ...
        const machinetypesDetailsResult =
          servicebrokerService.machinetypesDetails(machinetypesDetailsParams);
    ...
    describe('negative tests', () => {
      test('should enforce required parameters', async () => {
        let err;
        try {
          await servicebrokerService.machinetypesDetails({});
        } catch (e) {
          err = e;
        }
  ...
  describe('schematicWorkspaceGetoperation', () => {
    describe('positive tests', () => {
      function __schematicWorkspaceGetoperationTest() {
        ...
        const schematicWorkspaceGetoperationResult =
          servicebrokerService.schematicWorkspaceGetoperation(schematicWorkspaceGetoperationParams);
    ...
    describe('negative tests', () => {
      test('should enforce required parameters', async () => {
        let err;
        try {
          await servicebrokerService.schematicWorkspaceGetoperation({});
        } catch (e) {
          err = e;
        }
  ...
  describe('validatePowerVsWorkspace', () => {
    describe('positive tests', () => {
      function __validatePowerVsWorkspaceTest() {
        ...
        const validatePowerVsWorkspaceResult = servicebrokerService.validatePowerVsWorkspace(
      ...
      test('should prioritize user-given headers', () => {
        ...
        servicebrokerService.validatePowerVsWorkspace(validatePowerVsWorkspaceParams);
        checkMediaHeaders(createRequestMock, userAccept, userContentType);
      });
    });
    ...
    describe('negative tests', () => {
      test('should enforce required parameters', async () => {
        let err;
        try {
          await servicebrokerService.validatePowerVsWorkspace({});
        } catch (e) {
          err = e;
        }
  ...
  describe('validateProxyip', () => {
    describe('positive tests', () => {
      function __validateProxyipTest() {
        ...
        const validateProxyipResult = servicebrokerService.validateProxyip(validateProxyipParams);
      ...
      test('should prioritize user-given headers', () => {
        ...
        servicebrokerService.validateProxyip(validateProxyipParams);
        checkMediaHeaders(createRequestMock, userAccept, userContentType);
      });
    });
    ...
    describe('negative tests', () => {
      test('should enforce required parameters', async () => {
        let err;
        try {
          await servicebrokerService.validateProxyip({});
        } catch (e) {
          err = e;
        }
  ...
  describe('workspaceVpcgetoperation', () => {
    describe('positive tests', () => {
      function __workspaceVpcgetoperationTest() {
        ...
        const workspaceVpcgetoperationResult = servicebrokerService.workspaceVpcgetoperation(
      ...
      test('should prioritize user-given headers', () => {
        ...
        servicebrokerService.workspaceVpcgetoperation(workspaceVpcgetoperationParams);
        checkMediaHeaders(createRequestMock, userAccept, userContentType);
      });
    });
    ...
    describe('negative tests', () => {
      test('should enforce required parameters', async () => {
        let err;
        try {
          await servicebrokerService.workspaceVpcgetoperation({});
        } catch (e) {
          err = e;
        }
  ...
  describe('workspaceGetoperation', () => {
    describe('positive tests', () => {
      function __workspaceGetoperationTest() {
        ...
        const workspaceGetoperationResult = servicebrokerService.workspaceGetoperation(
      ...
      test('should prioritize user-given headers', () => {
        ...
        servicebrokerService.workspaceGetoperation(workspaceGetoperationParams);
        checkMediaHeaders(createRequestMock, userAccept, userContentType);
      });
    });
    ...
    describe('negative tests', () => {
      test('should enforce required parameters', async () => {
        let err;
        try {
          await servicebrokerService.workspaceGetoperation({});
        } catch (e) {
          err = e;
        }
  ...
  describe('serviceInstanceFetchManageDr', () => {
    describe('positive tests', () => {
      function __serviceInstanceFetchManageDrTest() {
        ...
        const serviceInstanceFetchManageDrResult =
          servicebrokerService.serviceInstanceFetchManageDr(serviceInstanceFetchManageDrParams);
    ...
    describe('negative tests', () => {
      test('should enforce required parameters', async () => {
        let err;
        try {
          await servicebrokerService.serviceInstanceFetchManageDr({});
        } catch (e) {
          err = e;
        }
  ...
  describe('serviceInstanceManageDr', () => {
    describe('positive tests', () => {
      ...
      function __serviceInstanceManageDrTest() {
        ...
        const serviceInstanceManageDrResult = servicebrokerService.serviceInstanceManageDr(
      ...
      test('should prioritize user-given headers', () => {
        ...
        servicebrokerService.serviceInstanceManageDr(serviceInstanceManageDrParams);
        checkMediaHeaders(createRequestMock, userAccept, userContentType);
      });
    });
    ...
    describe('negative tests', () => {
      test('should enforce required parameters', async () => {
        let err;
        try {
          await servicebrokerService.serviceInstanceManageDr({});
        } catch (e) {
          err = e;
        }
  ...
  describe('serviceInstanceDrdeployment', () => {
    describe('positive tests', () => {
      function __serviceInstanceDrdeploymentTest() {
        ...
        const serviceInstanceDrdeploymentResult = servicebrokerService.serviceInstanceDrdeployment(
          serviceInstanceDrdeploymentParams
        );
      ...
      test('should prioritize user-given headers', () => {
        ...
        servicebrokerService.serviceInstanceDrdeployment(serviceInstanceDrdeploymentParams);
        checkMediaHeaders(createRequestMock, userAccept, userContentType);
      });
    });
    ...
    describe('negative tests', () => {
      test('should enforce required parameters', async () => {
        let err;
        try {
          await servicebrokerService.serviceInstanceDrdeployment({});
        } catch (e) {
          err = e;
        }
  ...
  describe('serviceInstanceLastoperation', () => {
    describe('positive tests', () => {
      function __serviceInstanceLastoperationTest() {
        ...
        const serviceInstanceLastoperationResult =
          servicebrokerService.serviceInstanceLastoperation(serviceInstanceLastoperationParams);
    ...
    describe('negative tests', () => {
      test('should enforce required parameters', async () => {
        let err;
        try {
          await servicebrokerService.serviceInstanceLastoperation({});
        } catch (e) {
          err = e;
        }
  ...
  describe('serviceInstanceEventsGetquery', () => {
    describe('positive tests', () => {
      function __serviceInstanceEventsGetqueryTest() {
        ...
        const serviceInstanceEventsGetqueryResult =
          servicebrokerService.serviceInstanceEventsGetquery(serviceInstanceEventsGetqueryParams);
    ...
    describe('negative tests', () => {
      test('should enforce required parameters', async () => {
        let err;
        try {
          await servicebrokerService.serviceInstanceEventsGetquery({});
        } catch (e) {
          err = e;
        }
  ...
  describe('serviceInstanceEventsGet', () => {
    describe('positive tests', () => {
      function __serviceInstanceEventsGetTest() {
        ...
        const serviceInstanceEventsGetResult = servicebrokerService.serviceInstanceEventsGet(
      ...
      test('should prioritize user-given headers', () => {
        ...
        servicebrokerService.serviceInstanceEventsGet(serviceInstanceEventsGetParams);
        checkMediaHeaders(createRequestMock, userAccept, userContentType);
      });
    });
    ...
    describe('negative tests', () => {
      test('should enforce required parameters', async () => {
        let err;
        try {
          await servicebrokerService.serviceInstanceEventsGet({});
        } catch (e) {
          err = e;
        }
